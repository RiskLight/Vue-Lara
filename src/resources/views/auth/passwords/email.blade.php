    ...
    <div class="md:container md:mx-auto mb-20 pb-32 h-screen">
        <div class="flex justify-center">
            <div class="lg:w-1/2 border-blue-200 border-2 mt-20">
                <div
                    class="border-blue-200 border-2 bg-blue-100 h-10 uppercase font-bold flex items-center justify-center">{{ __('Сбросить пароль') }}</div>

                <div class="block p-6 rounded-lg shadow-lg bg-white max-w-full">
                    @if (session('status'))
                        <div class="bg-green-100 rounded-md p-3 flex mb-0 text-sm text-green-800 w-3/4 mx-auto"
                             role="alert">
                            {{ session('status') }}
                        </div>
                    @endif
                        ...
                        <div class="form-group mb-6">
                            ...
                            <div class="form-group form-check">
                                <input id="email" type="email"
                                       ...
                                       name="email" value="{{ old('email') }}" placeholder="Введите свой email " required autocomplete="email" autofocus>
